package com.sql.project.console.spring.aspectj;

import com.sql.project.console.common.Constant;
import com.sql.project.console.common.SessionInfo;
import com.sql.project.console.dto.LoginBean;
...
public class FuncAspect extends CommonAspect {
	...
	public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
		...
		RedirectView rv = new RedirectView("/console/");
